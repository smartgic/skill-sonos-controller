...
class SonosController(MycroftSkill):
    ...
    def _setup(self):
        ...
        self.add_event("recognizer_loop:wakeword", run_command(
            self, command='vol-down', speaker=None, extras=DEFAULT_VOL_INCREMENT))
        self.add_event("recognizer_loop:audio_output_end", run_command(
            self, command='vol-up', speaker=None, extras=DEFAULT_VOL_INCREMENT))
